...
5. List the open questions and who can answer each. STOP and call the AskUserQuestion tool to clarify. Resolve the ones that change the shape of the work; carry the rest into the spec as recorded unknowns.
