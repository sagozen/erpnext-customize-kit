 ...
 *   - `plugin/skills/pankit/SKILL.md` frontmatter version — generated;
 *     same rationale.
 *   - `dist/openai/pankit/.codex-plugin/plugin.json` version — generated
...
export function collectPluginVersions(rootDir) {
  ...
  const checks = [
    ...
    {
      relPath: 'dist/openai/pankit/.codex-plugin/plugin.json',
      read: (raw) => JSON.parse(raw).version,
    },
    {
      relPath: 'plugin/skills/pankit/SKILL.md',
