export function buildCodexPluginManifest(rootManifest) {
  return {
    ...
    interface: {
      ...
      longDescription: 'Create, critique, and refine frontend interfaces with your coding agent. PanKit provides 23 focused design commands, live browser iteration for exploring visual directions, and automatic checks that flag common design anti-patterns as you work.',
      ...
      defaultPrompt: [
        ...
        'start pankit live so I can explore bolder or more delightful variants.',
      ],
      brandColor: '#E2AE38',
