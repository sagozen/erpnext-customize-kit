...
async function detectHtml(filePath, options = {}) {
  ...
  if (!globalThis.__pankitStaticHtmlWarned) {
    globalThis.__pankitStaticHtmlWarned = true;

    process.stderr.write(
  'pankit detect: DEGRADED - HTML parser modules unavailable ' +
  ...
  // `pankit-disable` directives apply here — exactly the standalone-document
