 ...
 * session's `pankit-variants-start` marker). They had two near-identical
...
import { PANKIT_DIR } from '../lib/pankit-paths.mjs';
 ...
 *
 * `.pankit` is the critical entry, and it is not cosmetic. Progressive
 * publication stages each revision as `.pankit/live/artifacts/
 ...
 * hand.
 */
export const NEVER_SOURCE_DIRS = Object.freeze(['node_modules', '.git', PANKIT_DIR]);
