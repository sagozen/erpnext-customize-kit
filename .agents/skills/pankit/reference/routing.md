...
Read this when the user invokes `$pankit` with no argument. They are asking "what should I do next?" Answer with the stage their work is actually missing, not with a static list.
