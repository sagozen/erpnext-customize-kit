#!/usr/bin/env node
/**
 * Context-signals gatherer for the bare PanKit invocation
 ...
 * light: no LLM calls, no detector run (`npx pankit detect` is heavier and
 ...
 *   - critique:  the latest cached critique score (.pankit/critique)
...
// .pankit/, issue #303), a build artifact, or a dependency. Mirrors the
