/**
 * PanKit DevTools Extension - DevTools Page
 *
 * Creates the PanKit panel and triggers an auto-scan when DevTools opens.
...
chrome.devtools.panels.elements.createSidebarPane('PanKit', (sidebar) => {
...
const portName = `pankit-devtools-${chrome.devtools.inspectedWindow.tabId}`;
...
function connectLifecycle() {
  ...
  // Default ('panel'): wait until the user opens the PanKit panel or sidebar.
