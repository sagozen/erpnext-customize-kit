...
// completion gate.
const FORBIDDEN = [
  { marker: 'pankit-variants-start', why: 'variant wrapper comment left in source' },
  { marker: 'pankit-variants-end', why: 'variant wrapper comment left in source' },
  { marker: 'pankit-carbonize-start', why: 'carbonize block not rewritten into permanent form' },
  { marker: 'pankit-carbonize-end', why: 'carbonize block not rewritten into permanent form' },
  { marker: 'pankit-param-values', why: 'param-values comment not baked and removed' },
  { marker: 'data-pankit-', why: 'live-mode plumbing attribute left on markup' },
  ...
  { marker: '--pankit-variant-ready', why: 'preview readiness sentinel left in CSS' },
];
