...
export async function runPollStream(base, token, {
  ...
  process.stderr.write('[pankit-poll] stream mode: one JSON object per line on stdout; use --reply while this process stays running\n');
...
export async function pollCli() {
  ...
  if (args.includes('--help') || args.includes('-h')) {
    console.log(`Usage: pankit poll [options]
