...
Stage: **Define**. Invoked as `{{command_prefix}}pankit spec`.
...
5. List the open questions and who can answer each. {{ask_instruction}} Resolve the ones that change the shape of the work; carry the rest into the spec as recorded unknowns.
